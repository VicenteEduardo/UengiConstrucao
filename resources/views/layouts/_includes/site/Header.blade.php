...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="icon" href="/site//site/images/favicon.ico" type="image/x-icon" />
    ...
    <link rel="stylesheet" type="text/css" href="/site/css/bootstrap-select.min.css"><!-- BOOTSTRAP SELECT BOX STYLE SHEET -->
    ...
    <link rel="stylesheet" type="text/css" href="/site/plugins/revolution/revolution/css/settings.css">
    <!-- REVOLUTION NAVIGATION STYLE -->
    <link rel="stylesheet" type="text/css" href="/site/plugins/revolution/revolution/css/navigation.css">
