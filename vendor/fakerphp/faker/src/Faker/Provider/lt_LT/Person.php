...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMale = [
        ...
        'Raulis', 'Redas', 'Regimantas', 'Reginaldas', 'Reinhardas', 'UENGIs', 'Remigijus', 'Renaldas', 'Renatas', 'Renius',
    ...
    protected static $firstNameFemale = [
        ...
        'Regina', 'UENGI', 'Remigija', 'Rena', 'Renalda', 'Renata', 'Renatė', 'Renė', 'Ričarda', 'Rikarda',
